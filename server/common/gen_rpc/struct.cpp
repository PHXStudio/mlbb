...
void SGE_OrderInfo::serializeJson(std::ostream& ss, bool needBracket)const
{
	...
	ss << "\"productId_\":";
	{
		ss << (int64_t)productId_;
	}
	 ss << ",\n";
	// serialize productCount_
	ss << "\"productCount_\":";
	{
		ss << (int64_t)productCount_;
	}
	 ss << ",\n";
	// serialize amount_
	ss << "\"amount_\":";
...
void COM_ADLoginTotal::serializeJson(std::ostream& ss, bool needBracket)const
{
	...
	ss << "\"loginDays_\":";
	{
		ss << (int64_t)loginDays_;
	}
	 ss << ",\n";
	// serialize sinceStamp_
	ss << "\"sinceStamp_\":";
	{
		ss << (int64_t)sinceStamp_;
	}
	 ss << ",\n";
	// serialize endStamp_
	ss << "\"endStamp_\":";
	{
		ss << (int64_t)endStamp_;
	}
	 ss << ",\n";
	// serialize contents_
	ss << "\"contents_\":";
...
void COM_ScenePlayerInformation::serializeJson(std::ostream& ss, bool needBracket)const
{
	...
	ss << "\"weaponItemId_\":";
	{
		ss << (int64_t)weaponItemId_;
	}
	 ss << ",\n";
	// serialize fashionId_
	ss << "\"fashionId_\":";
	{
		ss << (int64_t)fashionId_;
	}
	 ss << ",\n";
	// serialize hpMax_
	ss << "\"hpMax_\":";
...
void COM_BattleEntityInformation::serialize(ProtocolWriter* __s__) const
{
	...
	{
		uint8_t __e__ = (uint8_t)battlePosition_;
		if(__e__){
		__s__->writeType(__e__);
		}
	}
...
void COM_Item::serializeJson(std::ostream& ss, bool needBracket)const
{
	...
	ss << "\"durability_\":";
	{
		ss << (int64_t)durability_;
	}
	 ss << ",\n";
	// serialize durabilityMax_
	ss << "\"durabilityMax_\":";
	{
		ss << (int64_t)durabilityMax_;
	}
	 ss << ",\n";
	// serialize usedTimeout_
	ss << "\"usedTimeout_\":";
	{
		ss << (int64_t)usedTimeout_;
	}
	 ss << ",\n";
	// serialize lastSellTime_
	ss << "\"lastSellTime_\":";
	{
		ss << (int64_t)lastSellTime_;
	}
	 ss << ",\n";
	// serialize propArr
	ss << "\"propArr\":";
...
void COM_QuestTarget::serializeJson(std::ostream& ss, bool needBracket)const
{
	...
	ss << "\"targetId_\":";
	{
		ss << (int64_t)targetId_;
	}
	 ss << ",\n";
	// serialize targetNum_
	ss << "\"targetNum_\":";
	{
		ss << (int64_t)targetNum_;
	}
	ss<<"\n";
	if(needBracket){ ss << "}"; }
}
...
void COM_Skill::serializeJson(std::ostream& ss, bool needBracket)const
{
	...
	ss << "\"skillExp_\":";
	{
		ss << (int64_t)skillExp_;
	}
	 ss << ",\n";
	// serialize skillLevel_
	ss << "\"skillLevel_\":";
	{
		ss << (int64_t)skillLevel_;
	}
	ss<<"\n";
	if(needBracket){ ss << "}"; }
}
...
void COM_BabyInst::serializeJson(std::ostream& ss, bool needBracket)const
{
	...
	ss << "\"intensifyLevel_\":";
	{
		ss << (int64_t)intensifyLevel_;
	}
	 ss << ",\n";
	// serialize intensifynum_
	ss << "\"intensifynum_\":";
	{
		ss << (int64_t)intensifynum_;
	}
	 ss << ",\n";
	// serialize lastSellTime_
	ss << "\"lastSellTime_\":";
...
void COM_EmployeeInst::serialize(ProtocolWriter* __s__) const
{
	...
	// serialize quality_
	{
		uint8_t __e__ = (uint8_t)quality_;
		if(__e__){
		__s__->writeType(__e__);
		}
	}
...
void SGE_ContactInfoExt::serializeJson(std::ostream& ss, bool needBracket)const
{
	...
	ss << "\"rolefirst_\":";
	{
		ss << (int64_t)rolefirst_;
	}
	 ss << ",\n";
	// serialize rolelast_
	ss << "\"rolelast_\":";
	{
		ss << (int64_t)rolelast_;
	}
	 ss << ",\n";
	// serialize logoutTime_
	ss << "\"logoutTime_\":";
	{
		ss << (int64_t)logoutTime_;
	}
	 ss << ",\n";
	// serialize gold_
	ss << "\"gold_\":";
	...
	ss << "\"magicgold_\":";
	{
		ss << (int64_t)magicgold_;
	}
	 ss << ",\n";
	// serialize guildContribute_
	ss << "\"guildContribute_\":";
	{
		ss << (int64_t)guildContribute_;
	}
	 ss << ",\n";
	// serialize accName_
	ss << "\"accName_\":";
...
void COM_Achievement::serialize(ProtocolWriter* __s__) const
{
	...
	// serialize achType_
	{
		uint8_t __e__ = (uint8_t)achType_;
		if(__e__){
		__s__->writeType(__e__);
		}
	}
...
void COM_PlayerInst::serialize(ProtocolWriter* __s__) const
{
	...
	{
		uint8_t __e__ = (uint8_t)magicItemeJob_;
		if(__e__){
		__s__->writeType(__e__);
		}
	}
	...
	if(gmActivities_.size())
	{
		...
		for(uint32_t i = 0; i < __len__; i++)
		{
			uint8_t __e__ = (uint8_t)gmActivities_[i];
			__s__->writeType(__e__);
		}
	}
	// serialize festival_
...
void COM_PlayerInst::serializeJson(std::ostream& ss, bool needBracket)const
{
	...
	ss << "\"onlineTimeReward_\":";
	{
		...
		for(uint32_t i = 0; i < __len__; i++)
		{
			ss << (int64_t)onlineTimeReward_[i];
			ss <<(((i+1) == __len__) ? "":",")<<"";
		}
		ss << "]";
	}
	...
	ss << "\"rivalNum_\":";
	{
		ss << (int64_t)rivalNum_;
	}
	 ss << ",\n";
	// serialize promoteAward_
	ss << "\"promoteAward_\":";
	{
		ss << (int64_t)promoteAward_;
	}
	 ss << ",\n";
	// serialize guideIdx_
	ss << "\"guideIdx_\":";
	{
		ss << (int64_t)guideIdx_;
	}
	 ss << ",\n";
	// serialize noTalkTime_
	ss << "\"noTalkTime_\":";
	...
	ss << "\"wishShareNum_\":";
	{
		ss << (int64_t)wishShareNum_;
	}
	 ss << ",\n";
	// serialize warriortrophyNum_
	ss << "\"warriortrophyNum_\":";
	{
		ss << (int64_t)warriortrophyNum_;
	}
	 ss << ",\n";
	// serialize employeelasttime_
	ss << "\"employeelasttime_\":";
	{
		ss << (int64_t)employeelasttime_;
	}
	 ss << ",\n";
	// serialize employeeonecount_
	ss << "\"employeeonecount_\":";
	{
		ss << (int64_t)employeeonecount_;
	}
	 ss << ",\n";
	// serialize employeetencount_
	ss << "\"employeetencount_\":";
	{
		ss << (int64_t)employeetencount_;
	}
	 ss << ",\n";
	// serialize greenBoxTimes_
	ss << "\"greenBoxTimes_\":";
	...
	ss << "\"magicItemLevel_\":";
	{
		ss << (int64_t)magicItemLevel_;
	}
	 ss << ",\n";
	// serialize magicItemeExp_
	ss << "\"magicItemeExp_\":";
	{
		ss << (int64_t)magicItemeExp_;
	}
	 ss << ",\n";
	// serialize magicItemeJob_
	ss << "\"magicItemeJob_\":";
	...
	{
		ss << (int64_t)guildContribution_;
	}
	 ss << ",\n";
	// serialize exitGuildTime_
	ss << "\"exitGuildTime_\":";
	{
		ss << (int64_t)exitGuildTime_;
	}
	 ss << ",\n";
	// serialize guildSkills_
	ss << "\"guildSkills_\":";
...
void COM_ReportTargetBase::serialize(ProtocolWriter* __s__) const
{
	...
	// serialize position_
	{
		uint8_t __e__ = (uint8_t)position_;
		if(__e__){
		__s__->writeType(__e__);
		}
	}
...
void COM_Order::serializeJson(std::ostream& ss, bool needBracket)const
{
	...
	ss << "\"uinteGroup_\":";
	{
		ss << (int64_t)uinteGroup_;
	}
	 ss << ",\n";
	// serialize uniteNum_
	ss << "\"uniteNum_\":";
	{
		ss << (int64_t)uniteNum_;
	}
	 ss << ",\n";
	// serialize isNo_
	ss << "\"isNo_\":";
...
void COM_InitBattle::serialize(ProtocolWriter* __s__) const
{
	...
	{
		uint8_t __e__ = (uint8_t)sneakAttack_;
		if(__e__){
		__s__->writeType(__e__);
		}
	}
...
void COM_CreateTeamInfo::serializeJson(std::ostream& ss, bool needBracket)const
{
	...
	ss << "\"minLevel_\":";
	{
		ss << (int64_t)minLevel_;
	}
	 ss << ",\n";
	// serialize maxLevel_
	ss << "\"maxLevel_\":";
	{
		ss << (int64_t)maxLevel_;
	}
	ss<<"\n";
	if(needBracket){ ss << "}"; }
}
...
void COM_BattleEmp::serialize(ProtocolWriter* __s__) const
{
	...
	{
		uint8_t __e__ = (uint8_t)empBattleGroup_;
		if(__e__){
		__s__->writeType(__e__);
		}
	}
...
void SGE_DBPlayerData::serializeJson(std::ostream& ss, bool needBracket)const
{
	...
	{
		ss << (int64_t)acceptRandQuestCounter_;
	}
	 ss << ",\n";
	// serialize submitRandQuestCounter_
	ss << "\"submitRandQuestCounter_\":";
	{
		ss << (int64_t)submitRandQuestCounter_;
	}
	 ss << ",\n";
	// serialize pfid_
	ss << "\"pfid_\":";
	...
	ss << "\"itemStoreSize_\":";
	{
		ss << (int64_t)itemStoreSize_;
	}
	 ss << ",\n";
	// serialize babyStoreSize_
	ss << "\"babyStoreSize_\":";
	{
		ss << (int64_t)babyStoreSize_;
	}
	 ss << ",\n";
	// serialize orders_
	ss << "\"orders_\":";
	...
	ss << "\"genItemMaxGuid_\":";
	{
		ss << (int64_t)genItemMaxGuid_;
	}
	 ss << ",\n";
	// serialize gaterMaxNum_
	ss << "\"gaterMaxNum_\":";
	{
		ss << (int64_t)gaterMaxNum_;
	}
	 ss << ",\n";
	// serialize firstRollEmployeeCon_
...
void COM_BattleOverClearing::serializeJson(std::ostream& ss, bool needBracket)const
{
	...
	ss << "\"playLevel_\":";
	{
		ss << (int64_t)playLevel_;
	}
	 ss << ",\n";
	// serialize playFree_
	ss << "\"playFree_\":";
	{
		ss << (int64_t)playFree_;
	}
	 ss << ",\n";
	// serialize pvpJJCGrade_
	ss << "\"pvpJJCGrade_\":";
	{
		ss << (int64_t)pvpJJCGrade_;
	}
	 ss << ",\n";
	// serialize money_
	ss << "\"money_\":";
...
void COM_Chat::serialize(ProtocolWriter* __s__) const
{
	...
	// serialize teamType_
	{
		uint8_t __e__ = (uint8_t)teamType_;
		if(__e__){
		__s__->writeType(__e__);
		}
	}
...
void COM_Chat::serializeJson(std::ostream& ss, bool needBracket)const
{
	...
	ss << "\"teamMinLevel_\":";
	{
		ss << (int64_t)teamMinLevel_;
	}
	 ss << ",\n";
	// serialize teamMaxLevel_
	ss << "\"teamMaxLevel_\":";
	{
		ss << (int64_t)teamMaxLevel_;
	}
	 ss << ",\n";
	// serialize teamName_
	ss << "\"teamName_\":";
...
void COM_Mail::serialize(ProtocolWriter* __s__) const
{
	...
	// serialize mailType_
	{
		uint8_t __e__ = (uint8_t)mailType_;
		if(__e__){
		__s__->writeType(__e__);
		}
	}
...
void COM_Guild::serializeJson(std::ostream& ss, bool needBracket)const
{
	...
	ss << "\"progenitusPositions_\":";
	{
		...
		for(uint32_t i = 0; i < __len__; i++)
		{
			ss << (int64_t)progenitusPositions_[i];
			ss <<(((i+1) == __len__) ? "":",")<<"";
		}
		ss << "]";
	}
...
void COM_GuildViewerData::serializeJson(std::ostream& ss, bool needBracket)const
{
	...
	ss << "\"memberNum_\":";
	{
		ss << (int64_t)memberNum_;
	}
	 ss << ",\n";
	// serialize memberTotal_
	ss << "\"memberTotal_\":";
	{
		ss << (int64_t)memberTotal_;
	}
	 ss << ",\n";
	// serialize guildRank_
	ss << "\"guildRank_\":";
	{
		ss << (int64_t)guildRank_;
	}
	ss<<"\n";
	if(needBracket){ ss << "}"; }
}
...
void COM_SellItem::serializeJson(std::ostream& ss, bool needBracket)const
{
	...
	ss << "\"sellPlayerId_\":";
	{
		ss << (int64_t)sellPlayerId_;
	}
	 ss << ",\n";
	// serialize sellPrice
	ss << "\"sellPrice\":";
	{
		ss << (int64_t)sellPrice;
	}
	 ss << ",\n";
	// serialize title_
	ss << "\"title_\":";
...
void COM_SelledItem::serializeJson(std::ostream& ss, bool needBracket)const
{
	...
	ss << "\"sellTime_\":";
	{
		ss << (int64_t)sellTime_;
	}
	 ss << ",\n";
	// serialize selledTime_
	ss << "\"selledTime_\":";
	{
		ss << (int64_t)selledTime_;
	}
	 ss << ",\n";
	// serialize itemId_
	ss << "\"itemId_\":";
...
void COM_ReconnectInfo::serialize(ProtocolWriter* __s__) const
{
	...
	{
		uint8_t __e__ = (uint8_t)reconnectProcess_;
		if(__e__){
		__s__->writeType(__e__);
		}
	}
...
void COM_Notice::serialize(ProtocolWriter* __s__) const
{
	...
	// serialize SendType_
	{
		uint8_t __e__ = (uint8_t)SendType_;
		if(__e__){
		__s__->writeType(__e__);
		}
	}
...
void SGE_Login::serializeJson(std::ostream& ss, bool needBracket)const
{
	...
	ss << "\"firsttime_\":";
	{
		ss << (int64_t)firsttime_;
	}
	 ss << ",\n";
	// serialize rolefirsttime_
	ss << "\"rolefirsttime_\":";
	{
		ss << (int64_t)rolefirsttime_;
	}
	 ss << ",\n";
	// serialize firstserid_
	ss << "\"firstserid_\":";
	{
		ss << (int64_t)firstserid_;
	}
	 ss << ",\n";
	// serialize serverid_
	ss << "\"serverid_\":";
...
void COM_Exam::serializeJson(std::ostream& ss, bool needBracket)const
{
	...
	ss << "\"questionIndex_\":";
	{
		ss << (int64_t)questionIndex_;
	}
	 ss << ",\n";
	// serialize rightNum_
	ss << "\"rightNum_\":";
	{
		ss << (int64_t)rightNum_;
	}
	 ss << ",\n";
	// serialize errorNum_
	ss << "\"errorNum_\":";
	{
		ss << (int64_t)errorNum_;
	}
	 ss << ",\n";
	// serialize money_
	ss << "\"money_\":";
