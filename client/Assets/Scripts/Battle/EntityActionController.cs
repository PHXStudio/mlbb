...
#region mem value
    ...
    void RefuseAction()
    {
        ...
        }, (GameObject go) =>
        {
			...
			//ClientLog.Instance.Log("���� No��  ContinueAction");
        });
		ContinueAction();
    }
...
//                            return;
            ...
            mainSkillInst = new SkillInst();
			//ClientLog.Instance.Log("���� No��  Cast: " + reportAction_.skill_ + "  caster : " + caster.InstName + " aim: " + aims[0].InstName + " len:" + aims.Count + " target: " + reportAction_.targets_[0].position_ + " len:" + reportAction_.targets_.Length);
