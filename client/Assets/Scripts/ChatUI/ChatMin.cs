...
{
    bool _IsInit = false; //��ʼ��һ��
    bool _IsDirty = true; //�Ƿ���Ҫ����

    bool[] _OpenChannels = new bool[(int)ChatKind.CK_Max];
    List<COM_ChatInfo> _ChannelInfo;
	//public UIFont _font;
    public UIGrid _Grid; //��ʾ�б�
    public GameObject _GridItem; //�б�Ԫ��
    ...
    Stack<GameObject> _GridItemCache = new Stack<GameObject>(); //����
    GameObject _Alloc()
    {
        GameObject o = null;
    ...
    void Update()
    {
        ...
        {
		   _MakedGridItem(i, _ChannelInfo[i]); //�����±���� �ǲ��Ǻ�
        }
        _CachedFreeGridItem(_ChannelInfo.Count); //���������� 
