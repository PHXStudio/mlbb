...
#region Create
	...
	static public void AddSprite ()
	{
		...
		{
			ClientLog.Instance.Log("You must select a game object first.");
		}
	}
	...
	static public void AddSprite2D ()
	{
		...
		else ClientLog.Instance.Log("You must select a game object first.");
	}
#endif
...
#region Attach
	...
	static public void AddCollider ()
	{
		...
		else ClientLog.Instance.Log("You must select a game object first, such as your button.");
	}
